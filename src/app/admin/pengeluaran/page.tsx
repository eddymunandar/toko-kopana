              ...
              <tbody className="divide-y divide-border">
                {loading ? (
                  ...
                  expenses.map((expense: any) => (
                    <tr key={expense.id} className="hover:bg-surface-hover/50 transition-colors text-sm">
                      ...
                      <td className="px-4 py-3">
                        <span className="px-2 py-1 bg-gray-100 rounded-lg text-xs font-semibold text-gray-600">{expense.category || 'Umum'}</span>
                      </td>
                    </tr>
                  ))
                )}
